...
void readProcessingTime(int a[2][10],int n)
{
  int i = 0, j = 0;
  for (i = 0; i <= 1; i++)
  {
...
void readTransferTime(int t[2][10],int n)
{
  int i = 0, j = 0;
  for (i = 0; i <= 1; i++)
  {
...
void print2dArray(int a[2][10], int n, char *str)
{
  int i=0,j;
...
void read1darray(int e[2], char *str,int n)
{
  for(int i =0 ; i<2; i++)
  {
...
void display1darray(int e[2], char *str,int n)
{
  printf("%s :\t",str);
  for(int i =0 ; i<n; i++)
  {
...
void printschedule(int L,int l[2][10],int n)
{
  int i = L;
  printf("\nS%d%d",i,n);
...
void calculate(int e[2], int x[],int a[][10], int t[][10], int n)
{
  int l[2][10],F=0,L=0;
  int f[2][10];
